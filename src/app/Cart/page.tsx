...
//   const [data, setData] = useState<bikeDataType[]>([]);
...
//   const debouncedRemoveBike = useCallback(
//     debounce((route: string) => {
//       const updatedBikeRoutes: bikeDataType[] = data.filter(
//         (val) => val.route !== route
//       );
//       localStorage.setItem("cartData", JSON.stringify(updatedBikeRoutes));
//       setData(updatedBikeRoutes);
//     }, 300),
//     [data]
//   );
...
//       style={{
//         backgroundImage:
//           "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.5)), url('/backpic1.jpg')",
//       }}
//     >
//       <Link href="/">
//         <button
//           className={`fixed bottom-5 right-5 z-[2000] h-12 w-12 bg-red-900 rounded-full items-center justify-center ${
//             data && data.length > 0 ? "flex" : "hidden"
//           }`}
//           title="Remove All"
//           onClick={() => emptyBikeData()}
//         >
...
//         {data.length > 0 &&
//           data.map((val: bikeDataType, ind: number) => (
//             <div
//               key={ind}
//               className="h-[440px] w-[380px] overflow-hidden shadow-car rounded-xl"
//             >
//               <motion.div
...
//         >
//           <h1 className="uppercase font-semibold text-white/60 sm:text-3xl text-2xl text-center w-full">
//           Your Cart Is Empty , Please Added Something!
//           </h1>
//           <Link href="/Inventory">
//             <button className="py-2 px-4 rounded-md bg-red-800 text-white font-semibold capitalize shadow-car">
//               Inventory
...
//       }
//     } catch (error) {
//       // Removed console.error to avoid warnings
//     }
//   };
