...
// interface BikeReportDataType {
//   category: string;
//   data: ReportArrayType[];
// }

// export interface BikeFeatureType {
//   img: string;
//   name: string;
// }


//   export const harleyDavidsonBikeData: BikeDataType[] = [
//     {
//       name: "Harley Davidson Street Glide",
//       brand: "harley-davidson",
//       price: "$21,999",
//       features: "G",
//       route: "harley-street-glide",
//       pictures: [
//         "bg-[url('/harley/street-glide/4.webp)]",
//         "bg-[url('/harley/street-glide/1.webp')]",
//         "bg-[url('/harley/street-glide/2.webp')]",
//         "bg-[url('/harley/street-glide/3.webp')]",
//         "bg-[url('/harley/street-glide/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$8,999",
//       features: "E",
//       route: "harley-iron-883",
//       pictures: [
//         "bg-[url('/harley/iron-883/3.webp')]",
//         "bg-[url('/harley/iron-883/2.webp')]",
//         "bg-[url('/harley/iron-883/1.webp')]",
//         "bg-[url('/harley/iron-883/4.webp')]",
//         "bg-[url('/harley/iron-883/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$22,999",
//       features: "A",
//       route: "harley-road-king",
//       pictures: [
//         "bg-[url('/harley/road-king/5.webp')]",
//         "bg-[url('/harley/road-king/1.webp')]",
//         "bg-[url('/harley/road-king/2.webp')]",
//         "bg-[url('/harley/road-king/3.webp')]",
//         "bg-[url('/harley/road-king/4.webp')]",
//       ],
//     },
//     {
...
//       price: "$19,999",
//       features: "C",
//       route: "harley-fat-boy",
//       pictures: [
//         "bg-[url('/harley/fat-boy/5.webp')]",
//         "bg-[url('/harley/fat-boy/1.webp')]",
//         "bg-[url('/harley/fat-boy/2.webp')]",
//         "bg-[url('/harley/fat-boy/3.webp')]",
//         "bg-[url('/harley/fat-boy/4.webp')]",
//       ],
//     },
//     {
...
//       price: "$16,499",
//       features: "F",
//       route: "harley-night-rod-special",
//       pictures: [
//         "bg-[url('/harley/night-rod-special/3.webp')]",
//         "bg-[url('/harley/night-rod-special/1.webp')]",
//         "bg-[url('/harley/night-rod-special/2.webp')]",
//         "bg-[url('/harley/night-rod-special/4.webp')]",
//         "bg-[url('/harley/night-rod-special/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$15,000",
//       features: "H",
//       route: "harley-sportster-s",
//       pictures: [
//         "bg-[url('/harley/sportster-s/3.webp')]",
//         "bg-[url('/harley/sportster-s/1.webp')]",
//         "bg-[url('/harley/sportster-s/2.webp')]",
//         "bg-[url('/harley/sportster-s/4.webp')]",
//         "bg-[url('/harley/sportster-s/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$11,299",
//       features: "B",
//       route: "harley-roadster",
//       pictures: [
//         "bg-[url('/harley/roadster/5.webp')]",
//         "bg-[url('/harley/roadster/1.webp')]",
//         "bg-[url('/harley/roadster/2.webp')]",
//         "bg-[url('/harley/roadster/3.webp')]",
//         "bg-[url('/harley/roadster/4.webp')]",
//       ],
//     },
//     {
...
//       price: "$21,999",
//       features: "I",
//       route: "harley-heritage-classic",
//       pictures: [
//         "bg-[url('/harley/heritage-classic/4.webp')]",
//         "bg-[url('/harley/heritage-classic/1.webp')]",
//         "bg-[url('/harley/heritage-classic/2.webp')]",
//         "bg-[url('/harley/heritage-classic/3.webp')]",
//         "bg-[url('/harley/heritage-classic/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$17,700",
//       features: "J",
//       route: "harley-pan-america-1250",
//       pictures: [
//         "bg-[url('/harley/pan-america-1250/4.webp')]",
//         "bg-[url('/harley/pan-america-1250/1.webp')]",
//         "bg-[url('/harley/pan-america-1250/2.webp')]",
//         "bg-[url('/harley/pan-america-1250/3.webp')]",
//         "bg-[url('/harley/pan-america-1250/5.webp')]",
//       ],
//     },
//     {
...
//       price: "$14,999",
//       features: "D",
//       route: "harley-softail-slim",
//       pictures: [
//         "bg-[url('/harley/softail-slim/3.webp')]",
//         "bg-[url('/harley/softail-slim/1.webp')]",
//         "bg-[url('/harley/softail-slim/2.webp')]",
//         "bg-[url('/harley/softail-slim/4.webp')]",
//         "bg-[url('/harley/softail-slim/5.webp')]",
//       ],
//     },
//   ];
...
//       pictures: [
//         "bg-[url('/hayabusa/Bikebon-edition/3.webp')]",
//         "bg-[url('/hayabusa/Bikebon-edition/1.webp')]",
//         "bg-[url('/hayabusa/Bikebon-edition/2.webp')]",
//         "bg-[url('/hayabusa/Bikebon-edition/4.webp')]",
//         "bg-[url('/hayabusa/Bikebon-edition/5.webp')]",
//       ],
//     },
//     {
...
//         "bg-[url('/hayabusa/se/5.webp')]",
//         "bg-[url('/hayabusa/se/1.webp')]",
//         "bg-[url('/hayabusa/se/2.webp')]",
//         "bg-[url('/hayabusa/se/4.webp')]",
//       ],
//     },
//     {
...
//         "bg-[url('/royal-enfield/classic-350/5.webp')]",
...
//       pictures: [
//         "bg-[url('/royal-enfield/interceptor-650/6.webp')]",
//         "bg-[url('/royal-enfield/interceptor-650/3.webp')]",
//         "bg-[url('/royal-enfield/interceptor-650/4.webp')]",
//         "bg-[url('/royal-enfield/interceptor-650/5.webp')]",
...
//         "bg-[url('/royal-enfield/meteor-350/5.webp')]",
...
//       pictures: [
//         "bg-[url('/royal-enfield/continental-gt-650/6.webp')]",
//         "bg-[url('/royal-enfield/continental-gt-650/4.webp')]",
//         "bg-[url('/royal-enfield/continental-gt-650/5.webp')]",
...
//       pictures: [
//         "bg-[url('/royal-enfield/himalayan/5.webp')]",
...
//         "bg-[url('/royal-enfield/bullet-350/5.webp')]",
...
//         "bg-[url('/royal-enfield/super-meteor-650/5.webp')]",
...
//         "bg-[url('/royal-enfield/thunderbird-x/5.webp')]",
...
//         "bg-[url('/royal-enfield/classic-500/5.webp')]",
...
//         "bg-[url('/royal-enfield/bullet-x500/5.webp')]",
...
//       feature: "A",
//       description:
//         "The [Bike Name] delivers an unparalleled blend of performance and style. Engineered for those who demand excellence, this motorcycle boasts a sleek exterior and a finely-tuned engine that provides exceptional acceleration and handling. Inside, the cockpit is meticulously designed, offering premium materials and advanced technology at your fingertips. With features like customizable ride modes and a cutting-edge infotainment system, the [Bike Name] is perfect for those who want both comfort and control on every ride.",
//     },
//     {
//       feature: "B",
//       description:
//         "Turn heads wherever you go with the stunning [Bike Name]. This bike is the perfect combination of style and performance, featuring a dynamic design that's sure to make an impression. Under the tank, its powerful engine ensures every ride is thrilling, while the advanced safety features keep you protected on the road. The rider's seat is a haven of comfort, and the intuitive dashboard puts all essential controls within easy reach. The [Bike Name] is designed for those who refuse to compromise.",
//     },
//     {
//       feature: "C",
//       description:
//         "Discover the next level of biking with the [Bike Name]. This motorcycle is crafted to elevate your experience, whether you're cruising down the highway or exploring winding country roads. With its refined design and cutting-edge technology, the [Bike Name] offers a smooth ride and seamless connectivity. The cockpit exudes luxury, featuring customizable riding positions and ergonomic controls for the perfect riding experience. Combined with its advanced rider-assistance systems, the [Bike Name] ensures every journey is safe, efficient, and enjoyable.",
//     },
//     {
//       feature: "D",
//       description:
//         "The [Bike Name] is where innovation meets performance. Powered by a robust engine and enhanced by superior handling, this motorcycle is built to deliver an exhilarating ride. Its aerodynamic design not only enhances speed but also improves fuel efficiency. Step into the cockpit, and you'll be surrounded by top-of-the-line materials and intuitive controls, making every ride comfortable and convenient. With smart technology at your fingertips, the [Bike Name] is your perfect companion for both daily commutes and long road trips.",
//     },
//     {
//       feature: "E",
//       description:
//         "Experience the ultimate in motorcycle engineering with the [Bike Name]. From the sleek, aggressive exterior to the luxurious, tech-filled cockpit, this bike is designed to impress. The powerful engine offers thrilling acceleration, while the advanced suspension ensures a smooth and controlled ride. Inside, the [Bike Name] is all about comfort and innovation, with a spacious cockpit, adjustable riding positions, and a state-of-the-art infotainment system. Whether you're on the open road or navigating through city traffic, the [Bike Name] turns every ride into a first-class experience.",
//     },
//     {
//       feature: "F",
//       description:
//         "Step into sophistication with the [Bike Name]. Built with meticulous attention to detail, this motorcycle combines a stylish exterior with exceptional performance. Its turbocharged engine delivers both power and efficiency, while the advanced safety features offer peace of mind at every turn. Inside, you'll find a refined cockpit, complete with leather seats, a premium sound system, and a panoramic visor. Whether you're heading to a weekend getaway or on a cross-country tour, the [Bike Name] ensures you arrive in style.",
//     },
//     {
//       feature: "G",
//       description:
//         "The [Bike Name] is engineered for those who crave excitement and refinement in equal measure. Its precision handling and powerful engine deliver a dynamic riding experience, whether you're exploring the open road or navigating through urban streets. Inside, the cockpit is both spacious and luxurious, with features like customizable handlebars and ambient lighting that create a personalized riding environment. The [Bike Name] also includes the latest in safety and entertainment technology, making it the perfect choice for the modern rider.",
//     },
//     {
//       feature: "H",
//       description:
//         "The [Bike Name] sets a new standard for luxury motorcycles. This model is equipped with the latest in motorcycle technology, from its powerful engine to its intuitive infotainment system. The exterior design is sleek and modern, while the cockpit offers premium comfort with adjustable seating, a climate-controlled cabin, and a high-definition touchscreen interface. With safety features like anti-lock brakes and advanced traction control, the [Bike Name] gives you confidence on every ride. Experience the future of motorcycling with the [Bike Name].",
//     },
//     {
//       feature: "I",
//       description:
//         "Ride with confidence on the [Bike Name]. Designed for optimal performance and comfort, this motorcycle features a high-output engine that delivers impressive speed and agility. The bold, aerodynamic design enhances both style and efficiency, while the cockpit is packed with luxury amenities like leather upholstery, an advanced sound system, and a smart navigation display. With an array of rider-assistance features, the [Bike Name] ensures that you can handle any road with ease and precision.",
//     },
//     {
//       feature: "J",
//       description:
//         "The [Bike Name] is more than just a motorcycle; it's a statement. This bike offers unparalleled performance thanks to its finely-tuned engine and cutting-edge engineering. The striking exterior design catches the eye, while the high-end cockpit provides comfort and sophistication for every rider. With features like a touchscreen entertainment system, wireless charging, and a panoramic rear-view system, the [Bike Name] delivers an elevated riding experience. Whether you're on a quick errand or a long road trip, the [Bike Name] makes every moment on the bike unforgettable.",
//     },
//   ];
...
// 3. Description Function (fixed filter issue)
// export const descriptionFunc = (
//   category: string,
//   descriptionArr: DescriptionType[],
//   bikeName: string
// ) => {
//   // const displayVal = DescriptionArr.find((val) => val.feature === category);
//   const displayVal = (descriptionArr || []).find((val) => val.feature === category);
// return displayVal;


// return displayVal?.description?.replaceAll("[Bike Name]", bikeName) 
//   ?? "Description not available for this category.";
...
// 4. Rating Function (fixed filter issue)
// export const RatingFunc = (
//   category: string,
//   ratingArr: BikeRatingType[],
//   bikeName: string
// ) => {
//   const displayVal = ratingArr.find((val) => val.features === category);

//   // If found, return the rating, else return a fallback or empty string
//   return displayVal
//     ? displayVal.rating.replaceAll("[Bike Name]", bikeName)
//     : "Rating not available for this category.";
// };
...
//   Type Definitions for Features and Reports (kept as-is)
//   interface BikeFeaturesType {
//     img: string;
//     name: string;
//   }
...
//   interface BikeReportDataType {
//     category: string;
//     data: { text: string; percentage: number }[];
//   }


// 1. Bike Features Data
// export const bikeFeaturesData: BikeFeaturesType[] = [
...
//   { img: "bg-[url('/bike-features/sport-mode.svg')]", name: "Sport Mode" },
//   { img: "bg-[url('/bike-features/navigation.svg')]", name: "Navigation System" },
//   { img: "bg-[url('/bike-features/rear-camera.svg')]", name: "Rear Camera" },
//   { img: "bg-[url('/bike-features/keyless.svg')]", name: "Keyless Start" },
//   { img: "bg-[url('/bike-features/power-lock.svg')]", name: "Power Locks" },
//   { img: "bg-[url('/bike-features/handlebar-controls.svg')]", name: "Handlebar Controls" },
//   { img: "bg-[url('/bike-features/power-mirror.svg')]", name: "Power Mirrors" },
//   { img: "bg-[url('/bike-features/radio.svg')]", name: "Bluetooth Audio System" },
//   { img: "bg-[url('/bike-features/led-headlights.svg')]", name: "LED Headlights" },
// ];

// 2. Shuffling Bike Features
// export const shufflingBikeFeatures = (features: BikeFeaturesType[]): BikeFeaturesType[] => {
//   const savedData = [...features];  // Clone the array to avoid mutation
//   let returningArray: BikeFeaturesType[] = [];
...
// 5. Bike Report Data (added fallback in case category not found)
// export const bikeReportRates: BikeReportDataType[] = [
//   {
//     category: "A",
//     data: [
...
// export const setBikeReport = (category: string): BikeReportDataType | undefined => {
//   const bikeReport = bikeReportRates.find((val) => val.category === category);
